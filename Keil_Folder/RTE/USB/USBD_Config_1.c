...
#define USBD1_STR_DESC_MAN              L"Frying Chips"

//     <s.126>Product String
//     <i>String Descriptor describing Product.
#define USBD1_STR_DESC_PROD             L"MBA Device"
...
#define USBD1_STR_DESC_SER              L"000000000001"
